...
This file contains crucial context and acts as an index for task tracking and memory for AI agents working on the Sprint Escape project. 
**Agents must review this file before starting new work.**
